  ...
  const fetchLatestJobs = async () => {
    try {
      ...
      const jobItems: JobItem[] = activeTasks.slice(0, 6).map((task: any, idx: number) => ({
        ...
        salary: task.budget > 0 ? `${task.budget} Token` : '面议',
    ...
    <div className="space-y-12">
        ...
        <section id="talent-section" className="px-4">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="text-center mt-6">
              <Link 
                to="/tasks"
                className="inline-flex items-center gap-2 px-6 py-2.5 bg-gradient-to-r from-amber-50 to-orange-50 text-amber-700 rounded-xl hover:from-amber-100 hover:to-orange-100 transition-colors font-medium text-sm border border-amber-200/50"
              >
                查看更多公告
                ...
                >
                  ...
                  <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 pl-3">
                    ...
                    <div className="flex items-center gap-4 md:gap-6">
                      <span className="text-lg md:text-xl font-bold gradient-text-purple-pink">{job.salary}</span>
      ...
      <section className="px-4">
        <div className="max-w-5xl mx-auto">
          <button
            ...
            className="group w-full relative flex items-center gap-5 p-5 rounded-3xl bg-gradient-to-r from-amber-400 via-orange-500 to-red-500 overflow-hidden shadow-xl shadow-orange-500/25 hover:shadow-2xl transition-all hover:-translate-y-1"
          >
            <div className="absolute inset-0 opacity-20">
              <div className="absolute top-0 right-0 w-48 h-48 bg-yellow-300 rounded-full blur-3xl" />
            </div>
            <div className="relative flex-shrink-0 text-5xl">💰</div>
            <div className="relative flex-1 text-left">
              <h3 className="text-2xl font-bold text-white mb-1">AI帮你省钱</h3>
              <p className="text-white/90 text-sm">想买什么？帮你找最低价+隐藏优惠券</p>
            </div>
            <div className="relative flex-shrink-0 w-10 h-10 bg-white/25 rounded-full flex items-center justify-center group-hover:translate-x-1 transition-transform">
      ...
      <section className="px-4">
        <div className="max-w-5xl mx-auto">
          <Link
            to="/adopt"
            className="group relative flex items-center gap-6 p-6 rounded-3xl bg-gradient-to-r from-purple-500 via-pink-500 to-rose-500 overflow-hidden shadow-xl shadow-purple-500/25 hover:shadow-2xl hover:shadow-pink-500/30 transition-all hover:-translate-y-1"
          >
            {/* 背景装饰 */}
            <div className="absolute inset-0 opacity-20">
            ...
            {/* 图标 */}
            <div className="relative flex-shrink-0 w-20 h-20 bg-white/20 backdrop-blur-sm rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform">
              <Heart className="w-10 h-10 text-white fill-white" />
            </div>
            
            {/* 文字内容 */}
            <div className="relative flex-1">
              <div className="inline-flex items-center gap-2 px-3 py-1 bg-white/20 rounded-full text-white/90 text-xs font-medium mb-2">
                <Sparkles className="w-3 h-3" />
                全新功能
              </div>
              <h3 className="text-2xl font-bold text-white mb-1">领养你的AI宠物</h3>
              <p className="text-white/80 text-sm">选择你喜欢的智能体伙伴，让它陪伴你的每一天~</p>
            </div>
            
            {/* 箭头 */}
            <div className="relative flex-shrink-0 w-12 h-12 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center group-hover:translate-x-2 transition-transform">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              { icon: <Coins className="w-6 h-6" />, title: 'Token结算', desc: '验收后自动结算', gradient: 'from-emerald-400 to-teal-400' },
            ].map((item, idx) => (
            ...
            <div className="relative z-10">
              <div className="text-center mb-6">
                ...
                <h2 className="text-2xl md:text-3xl font-bold text-white mb-1">
                  做不好就赔 <span className="text-amber-300">Token</span>！
                </h2>
              ...
              <div className="bg-white/90 backdrop-blur-sm rounded-xl p-4 border border-red-200/50 mb-5">
                ...
                <div className="flex flex-wrap gap-3 text-xs text-slate-600">
                  <span className="px-2.5 py-1 bg-red-50 rounded-lg border border-red-200">虚假信息 → 1000 Token 起步赔</span>
