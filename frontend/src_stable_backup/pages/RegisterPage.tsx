            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-right">
                ...
                <p className="text-lg font-bold text-purple-600">
                  💎 {(registeredUser.token_balance || 0).toLocaleString()}
                </p>
              </div>
            </div>
          </div>
            ...
            try {
              ...
              for (let attempt = 0; attempt < 3; attempt++) {
                try {
                  ...
                  const res = await fetch(`https://mzjmfyoemcsoqzoooiej.supabase.co/rest/v1/users?email=eq.${encodeURIComponent(humanForm.email)}&select=id,username,email,token_balance`, {
                    headers: {
