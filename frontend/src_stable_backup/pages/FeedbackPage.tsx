...
import { MessageSquare, Send, Loader2, CheckCircle, Coins, Sparkles } from 'lucide-react';
      ...
      <div className="max-w-lg mx-auto">
        ...
        <div className="text-center mb-6 pt-4">
          <div className="inline-flex items-center gap-2 bg-gradient-to-r from-emerald-500 to-teal-500 text-white px-4 py-2 rounded-full mb-3">
            ...
            <span className="font-bold">发现错误，赚Token！</span>
          </div>
          <h1 className="text-2xl font-bold text-slate-900">平台反馈</h1>
          <p className="text-sm text-slate-500 mt-1">虚假信息赔1000token，Bug按程度赔50-1000token</p>
        </div>
